...
CREATE TABLE TB_BRASSAGEM_MOAGEM(
	ID_BRASSAGEM_MOAGEM INT PRIMARY KEY IDENTITY(1,1) NOT NULL,
	ID_MOAGEM INT NOT NULL,
	ID_BRASSAGEM INT NOT NULL,
	FOREIGN KEY (ID_MOAGEM) REFERENCES TB_MOAGEM(ID_MOAGEM),
